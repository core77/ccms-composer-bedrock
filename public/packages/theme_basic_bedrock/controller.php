...
class Controller extends Package {
    ...
    public function on_start() {
        ...
        $al->register('css', 'basic-bedrock-app-css',  $this->themePath . 'css/main.css', ['position' => AssetInterface::ASSET_POSITION_HEADER, 'local'=>true], $this->pkgHandle);
        $al->register('javascript', 'basic-bedrock-app-js',  $this->themePath . 'js/main.js', ['position' => AssetInterface::ASSET_POSITION_FOOTER, 'local'=>true], $this->pkgHandle);
