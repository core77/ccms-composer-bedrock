            ...
            <a class="navbar-brand" href="<?=$home->getCollectionLink()?>">
                <?php if ($logo && ($includeBrandLogo && $includeBrandText)) { ?>
                    ...
                    <?php if (isset($transparentLogo)) { ?>
                        <!-- Add alt tag -->
                        <img src="<?=$transparentLogo->getURL()?>" alt="<?=$transparentLogo->getDescription()?>" class="logo-transparent align-text-center">
                    <?php } ?>
                    <?=h($brandingText)?>
                <?php } ?>
                <?php if ($logo && ($includeBrandLogo && !$includeBrandText)) { ?>
                    <!-- Add alt tag -->
                    <img src="<?=$logo->getURL()?>" alt="<?=$logo->getDescription()?>"class="logo">
                    <?php if (isset($transparentLogo)) { ?>
                        <!-- Add alt tag -->
                        <img src="<?=$transparentLogo->getURL()?>" alt="<?=$transparentLogo->getDescription()?>" class="logo-transparent">
                    <?php } ?>
                <?php } ?>
